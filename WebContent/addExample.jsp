...
<body>
   <!-- 导航条 -->
    ...
    <div class="container">
        <form class="form-horizontal" role="form" id="edit" name="edit"
            ACTION="AddExample" METHOD="POST">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label "
                            for="sampleAge">受检者年龄*</label>
                        <div class="col-sm-4 controls">
                            <input type="text" id="sampleAge"
                                placeholder="sampleAge">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label "
                            for="sampleType">受检者类型* </label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label "
                            for="samplePhone">受检者电话</label>
                        <div class="col-sm-4 controls">
                            <input type="text" id="samplePhone"
                                placeholder="samplePhone">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label "
                            for="sampleAddress">受检者地址</label>
                        <div class="col-sm-4 controls">
                            <input type="text" id="sampleAddress"
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label "
                            for="sampleClinic">临床表现*</label>
                        <div class="col-sm-4controls">
                            <textarea class="form-control" rows="4"
                                placeholder="sampleClinic"></textarea>
                        </div>
                    </div>
                </div>
                <!-- 表单第二列 -->
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="row col-sm-12 vertical-middle-sm">
                        <div class="col-sm-6">
                            <button type="submit"
                                class="btn btn-sm btn-primary btn-block">提交</button>
                        </div>
                        <div class="col-sm-6">
                            <button type="reset"
                                class="btn btn-sm btn-primary btn-block">重置</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-4"></div>
